    ...
    >
      <div class="content">
        ...
        <div class="pt-5">
          <div class="flex justify-between">
            <div>
              <h2 class="lg:text-xl font-bold mb-4">
                Invoice Details <span class="text-blue-600 font-bold">#NRjhkfjsfsfs</span>
              </h2>
            </div>
          ...
          <h1 class="text-left font-bold pb-2 pt-5 text-xl">Details</h1>
          <div class="grid lg:grid-cols-2 gap-4">
            <div>
              <label class="block mb-2 text-left font-bold">Bill From</label>
              <input
                type="text"
                class="w-full text-gray-500 px-4 py-2 bg-blue-50 text-xl border-2 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600 focus:border-blue-600 placeholder-white transition"
              />
            </div>
            <div>
              ...
              <input
                type="text"
                class="w-full text-gray-500 px-4 py-2 text-xl bg-blue-50 border-2 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600 focus:border-blue-600 placeholder-white transition"
              />
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 gap-4 pt-2">
            <div>
              <label class="block mb-2 text-left font-bold"
                >Bill Title/Project Descriptions</label
              >
              <input
                type="text"
                class="w-full text-gray-500 px-4 py-2 bg-blue-50 text-xl border-2 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600 focus:border-blue-600 placeholder-white transition"
          ...
          <div class="grid lg:grid-cols-2 gap-4 pt-2">
            ...
            <label class="flex items-center space-x-2">
              ...
              <span class="text-sm font-medium text-gray-500 whitespace-nowrap"
                >This is a recurring invoice (Monthly)</span
              >
            </label>
          </div>

          <h1 class="text-left font-bold pb-2 pt-5 text-xl">Invoice Item</h1>
          ...
          <div class="grid grid-cols-3 whitespace-nowrap gap-10 lg:gap-4 pt-2">
            ...
            <div>
              <span class="block mb-2 text-xl text-left font-bold text-black"
                >Total Amount</span
              >
            </div>
            <div>
          ...
          <h1 class="text-left font-bold pb-2 pt-5 text-xl">Notes</h1>
          <div class="grid grid-cols-1 gap-4">
            <div>
              <textarea
          ...
          <div class="flex justify-center lg:justify-end m-4 pb-10">
            <v-button size="small" :loading="loading" class="py-4 text-xl" type="sec"
              >Create Invoice</v-button
            >
          </div>
        </div>
      </div>
